...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "SPI_PRESCALER" -parent ${Page_0}


}

proc update_PARAM_VALUE.SPI_PRESCALER { PARAM_VALUE.SPI_PRESCALER } {
	# Procedure called to update SPI_PRESCALER when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.SPI_PRESCALER { PARAM_VALUE.SPI_PRESCALER } {
	# Procedure called to validate SPI_PRESCALER
	return true
}
...
proc update_MODELPARAM_VALUE.SPI_PRESCALER { MODELPARAM_VALUE.SPI_PRESCALER PARAM_VALUE.SPI_PRESCALER } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.SPI_PRESCALER}] ${MODELPARAM_VALUE.SPI_PRESCALER}
}

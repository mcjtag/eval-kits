...
static void set_pll(u8 divf, u8 divq, u8 range)
{
	...
	SET_BIT(data[0], 2, GET_BIT(range,2));
	SET_BIT(data[0], 3, GET_BIT(divf,0));
	SET_BIT(data[0], 4, GET_BIT(divf,1));
	SET_BIT(data[0], 5, GET_BIT(divf,2));
	SET_BIT(data[0], 6, GET_BIT(divf,3));
	...
	SET_BIT(data[1], 4, GET_BIT(divq,1));

...
# Create project
create_project project_top . -part xc7a200tfbg484-2 -force
# Restore old sources
...
set_property "sim.central_dir" "d:/projects/eval-kits/ek-m-oas2/fpga/project_demo/project_top.ip_user_files" $obj
...
set files [list \
 ...
 "[file normalize "$origin_dir/project_top.srcs/sources_1/bd/design_top/ip/design_top_mig_7series_0_0/mig_a.prj"]"\
]
...
set file "design_top_mig_7series_0_0/mig_a.prj"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/project_top.srcs/constrs_1/new/clk.xdc"]"
set file_added [add_files -norecurse -fileset $obj $file]
...
set_property "target_part" "xc7a200tfbg484-2" $obj
...
if {[string equal [get_runs -quiet synth_1] ""]} {
  create_run -name synth_1 -part xc7a200tfbg484-2 -flow {Vivado Synthesis 2018} -strategy "Vivado Synthesis Defaults" -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
  create_run -name impl_1 -part xc7a200tfbg484-2 -flow {Vivado Implementation 2018} -strategy "Vivado Implementation Defaults" -constrset constrs_1 -parent_run synth_1
} else {

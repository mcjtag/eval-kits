...
## PLL
# DIVR
set_property -dict {PACKAGE_PIN J3 IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 12} [get_ports dsp_pll_divr[0]]
set_property -dict {PACKAGE_PIN R7 IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 12} [get_ports dsp_pll_divr[1]]
set_property -dict {PACKAGE_PIN N7 IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 12} [get_ports dsp_pll_divr[2]]
set_property -dict {PACKAGE_PIN N8 IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 12} [get_ports dsp_pll_divr[3]]
set_property -dict {PACKAGE_PIN P8 IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 12} [get_ports dsp_pll_divr[4]]

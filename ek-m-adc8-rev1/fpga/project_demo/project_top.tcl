...
set_property "sim.central_dir" "D:/projects/eval-kits/ek-m-adc8/fpga/project_demo/project_top.ip_user_files" $obj
...
set files [list \
 ...
 "[file normalize "$origin_dir/project_top.srcs/sources_1/bd/design_top/ip/design_top_mig_7series_0_0/mig_b.prj"]"\
]
...
set file "design_top_mig_7series_0_0/mig_b.prj"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property "scoped_to_cells" "design_top_mig_7series_0_0" $file_obj
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/project_top.srcs/constrs_1/new/clock.xdc"]"
set file_added [add_files -norecurse -fileset $obj $file]
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/project_top.srcs/constrs_1/new/adc8_link.xdc"]"
set file_added [add_files -norecurse -fileset $obj $file]
set file "new/adc8_link.xdc"
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property "file_type" "XDC" $file_obj

# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/project_top.srcs/constrs_1/new/adc8_clock.xdc"]"
set file_added [add_files -norecurse -fileset $obj $file]
set file "new/adc8_clock.xdc"
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property "file_type" "XDC" $file_obj

# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/project_top.srcs/constrs_1/new/adc8_spi.xdc"]"
set file_added [add_files -norecurse -fileset $obj $file]
set file "new/adc8_spi.xdc"
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property "file_type" "XDC" $file_obj
...
set obj [get_filesets constrs_1]
set_property "target_constrs_file" "$orig_proj_dir/project_top.srcs/constrs_1/new/top.xdc" $obj
set_property "target_part" "xc7a200tffg1156-2" $obj
set_property "target_ucf" "$orig_proj_dir/project_top.srcs/constrs_1/new/top.xdc" $obj
...
if {[string equal [get_runs -quiet synth_1] ""]} {
  create_run -name synth_1 -part xc7a200tffg1156-2 -flow {Vivado Synthesis 2018} -strategy "Vivado Synthesis Defaults" -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
  create_run -name impl_1 -part xc7a200tffg1156-2 -flow {Vivado Implementation 2018} -strategy "Vivado Implementation Defaults" -constrset constrs_1 -parent_run synth_1
} else {
